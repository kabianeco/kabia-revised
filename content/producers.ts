...
"mutfak": [
  {
    ...
    "story": "Geyve'de Ağustos ortasında domatesler dalında kızarınca toplanır. Sabah serinliğinde elde doğranır, geniş tepsilere serilir, günlerce güneşte ve rüzgarda ağır ağır koyulaşır. İçinde sadece domates ve kaya tuzu var; salça kıvamına gelince cam kavanozlara konur. Koruyucu yok, hızlandırıcı yok. Her kavanozun üzerine hasat haftası yazılır — aynı mutfakta, yıllardır aynı eller yapar.",
    "productionPlace": null,
    "method": null,
    "inputs": null,
    "certificates": null,
